...
class ZingMp3Api {
    ...
    //getDetailPlaylistBottom
    getDetailPlaylistBottom(playlistId) {
        return new Promise((resolve, rejects) => {
            this.requestZingMp3("/api/v2/playlist/get/section-bottom", {
                id: playlistId,
                sig: this.hashParam("/api/v2/playlist/get/section-bottom", playlistId)
            })
                .then((res) => {
                    resolve(res);
                })
...
// instance default
exports.ZingMp3 = new ZingMp3Api("1.8.5", // VERSION
